...
public:
    ...
    explicit
        session(net::io_context& ioc, ssl::context& ctx, std::string wsPath)
        ...
        on_ssl_handshake(beast::error_code ec)
    {
        ...
        ws_.async_handshake(host_, wsPath,
            beast::bind_front_handler(
...
int dw::App::testws(){
  ...
  "id": 0
    ...
    std::make_shared<session>(ioc, ctx, "/ws/api/v2")->run(host, port, text);
